const videos = {
  ...
  Física: [
    ...
    { title: "Aula 4: Ondulatória", url: "https://www.youtube.com/embed/fVbgf7sLr8c" }
  ],
  Português: [
    ...
    { title: "Aula 3: Redação Dissertativa", url: "https://www.youtube.com/embed/QjewXptmV6U" },
    { title: "Aula 4: Ortografia", url: "https://www.youtube.com/embed/gFlIJuiAzOs" }
  ],
  Inglês: [
    { title: "Aula 1: Verbos Básicos", url: "https://www.youtube.com/embed/bSeZlT7Og8I" },
    { title: "Aula 2: Vocabulário Básico", url: "https://www.youtube.com/embed/8wx6MUDIT4I" },
    { title: "Aula 3: Conversação", url: "https://www.youtube.com/embed/gt_aEXKeuco" },
    { title: "Aula 4: Expressões Comuns", url: "https://www.youtube.com/embed/lVbycf55xPU" }
  ],
  História: [
    ...
    { title: "Aula 3: Renascimento", url: "https://www.youtube.com/embed/cTouipcMAIs" },
    { title: "Aula 4: Era Moderna", url: "https://www.youtube.com/embed/SI8fs5eqe74" }
  ]
};
...
function enterSite() {
  ...
  loadVideos();
  goHome();  // Exibe todas as categorias ao entrar
}
...
function openCategory(category) {
  ...
  document.getElementById(`${category.toLowerCase()}-section`).style.display = "block";
}
